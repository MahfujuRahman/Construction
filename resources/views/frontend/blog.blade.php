        ...
        <div id="featured-title-inner" class="container clearfix">
            <div class="featured-title-inner-wrap">
                <div class="featured-title-heading-wrap">
                    <h1 class="featured-title-heading">News</h1>
                </div>
                <div id="breadcrumbs">
                ...
                <div id="inner-content" class="inner-content-wrap">
                    <article class="hentry">
                        <div class="post-media clearfix">
                            <a href="#"><img src="assets/img/news/1.jpg" alt="image"></a>
                        </div><!-- /.post-media -->

                        <div class="post-content-wrap">
                            <h2 class="post-title">
                                <span class="post-title-inner">
                                    <a href="#">Best Treehouse Plans</a>
                                </span>
                            </h2><!-- /.post-title -->
                                ...
                                <div class="post-meta-content">
                                    <div class="post-meta-content-inner">
                                        <span class="post-by-author item">
                                            <span class="inner">By <a href="#" title=""
                                                    rel="author">Construction</a></span>
                                        </span>

                                        <span class="post-date item">
                                            <span class="inner"><span class="entry-date">December 30,
                                                    2016</span></span>
                                        </span>
                                        ...
                                        <span class="post-meta-categories item">
                                            <span class="inner">
                                                <a href="#" rel="category">Building</a>,
                                                <a href="#" rel="category">Construction</a>,
                                                <a href="#" rel="category">Architecture</a>,
                                                <a href="#" rel="category">Green House</a>
                                            </span>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="post-content post-excerpt">
                                <p>Integer rhoncus hendrerit sem egestas porttitor. Integer et mi sed dolor eleifend
                                    pretium quis ut velit. Nam sit amet arcu feugiat, consequat orci at, ultrices magna.
                                    Aliquam vestibulum, eros vel venenatis vulputate, erat augue suscipit mi, nec
                                    rhoncus velit ipsum sed lorem. Nulla commodo leo eget justo blandit, non sagittis
                                    lectus dignissim.</p>
                            </div><!-- /.post-excerpt -->
                    ...
                    <article class="hentry">
                        <div class="post-media clearfix">
                            <a href="#"><img src="assets/img/news/2.jpg" alt="image"></a>
                        </div><!-- /.post-media -->

                        <div class="post-content-wrap">
                            <h2 class="post-title">
                                <span class="post-title-inner">
                                    <a href="#">The Future of Buildings</a>
                                </span>
                            </h2><!-- /.post-title -->
                    ...
                    <article class="hentry">
                        <div class="post-media clearfix">
                            <a href="#"><img src="assets/img/news/3.jpg" alt="image"></a>
                        </div><!-- /.post-media -->
                    ...
                    <div class="wprt-pagination clearfix">
                        <ul class="page-numbers">
                            ...
                            <li><a class="next page-numbers" href="#"><span
                ...
                <div id="inner-sidebar" class="inner-content-wrap">
                    ...
                    <div id="widget_news_post-3" class="widget widget_recent_news">
                        ...
                        <ul class="recent-news clearfix">
                            <li class="clearfix">
                                <div class="thumb">
                                    <img width="150" height="150" src="assets/img/news/1s.jpg" alt="image">
                                </div><!-- /.thumb -->

                                <div class="texts">
                                    <h3><a href="#">Best Treehouse Plans</a></h3>
                            ...
                            <li class="clearfix">
                                <div class="thumb">
                                    <img width="150" height="150" src="assets/img/news/2s.jpg" alt="image">
                                </div><!-- /.thumb -->

                                <div class="texts">
                                    <h3><a href="#">The Future of Buildings</a></h3>
                                    <span class="post-date"><span class="entry-date">December 30, 2016</span></span>
                                </div><!-- /.texts -->
                            </li>
                            ...
                            <li class="clearfix">
                                <div class="thumb">
                                    <img width="150" height="150" src="assets/img/news/3s.jpg" alt="image">
                                </div><!-- /.thumb -->
