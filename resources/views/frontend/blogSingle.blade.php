                ...
                <div class="post-content-single-wrap">
                    <article class="hentry">
                            ...
                            <div class="post-meta-content">
                                <div class="post-meta-content-inner">
                                    <span class="post-by-author item">
                                        <span class="inner">By <a href="#" title="" rel="author">Construction</a></span>
                                    </span>

                                    <span class="post-date item">
                                        <span class="inner"><span class="entry-date">December 30, 2016</span></span>
                                    </span>
                        ...
                        <div class="post-tags clearfix">
                            Tags:
                            <a href="#" rel="tag">Architectural</a>
                            <a href="#" rel="tag">Builder</a>
                            <a href="#" rel="tag">construction</a>
                        </div><!-- /.post-tags -->
                            ...
                            <ol class="comment-list">
                                <li class="comment">
                                    <article class="comment-wrap clearfix">
                                        <div class="gravatar"><img alt="image" src="assets/img/avatar.png" /></div>
                                        <div class="comment-content">
                                            <div class="comment-meta">
                                                <h6 class="comment-author">BlogWP</h6>
                                                <span class="comment-time">12/30/2016</span>
                            ...
                            <div id="respond" class="comment-respond">
                                ...
                                <form action="#" method="post" id="commentform" class="comment-form">
                                    <fieldset class="message-wrap">
                                        <textarea id="comment-message" name="comment" rows="8" tabindex="4" placeholder="Message"></textarea>
                                    </fieldset>
