...
@section('content')
    <div class="page-content">
            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header text-primary display-6 text-center"><strong>{{ __('All Agent Table') }}</strong></div>
                        ...
                        <div class="card-body " style="overflow-y: hidden;">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <a href="{{ route('admin.create') }}" class="btn btn-primary mb-3">Create New Agent</a>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.destroy', $user->id) }}" method="POST"
                                                    ...
                                                    <button type="submit" class="btn btn-danger btn-sm"
                                                        onclick="return confirm('Are you sure?')" id="delete-button">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
